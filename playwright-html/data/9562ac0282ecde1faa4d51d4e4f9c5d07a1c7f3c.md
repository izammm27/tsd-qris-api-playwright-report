...
- Name: api\get-token\get-token.combination.spec.ts >> Get Token B2B combination and validation priority >> GT-CMB-013 - valid authentication and multiple body validation errors / Valid authentication and multiple body validation errors
- Location: tests\api\get-token\get-token.combination.spec.ts:176:9

# Error details

```
Error: GT-CMB-013: responseCode tidak sesuai. Expected: 4007301; Actual: 4007300 / GT-CMB-013: responseCode mismatch. Expected: 4007301; Actual: 4007300
```
