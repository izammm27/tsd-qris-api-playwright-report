...
- Name: api\get-token\get-token.body-negative.spec.ts >> Get Token B2B body negative and raw body contract >> GT-BDY-031 - partnerId string kosong / partnerId empty string
- Location: tests\api\get-token\get-token.body-negative.spec.ts:16:9

# Error details

```
Error: GT-BDY-031: responseCode tidak sesuai. Expected: 4007301; Actual: 4007302 / GT-BDY-031: responseCode mismatch. Expected: 4007301; Actual: 4007302
```
