...
- Name: api\get-token\get-token.body-negative.spec.ts >> Get Token B2B body negative and raw body contract >> GT-BDY-013 - grantType array / grantType array
- Location: tests\api\get-token\get-token.body-negative.spec.ts:16:9

# Error details

```
Error: GT-BDY-013: responseCode tidak sesuai. Expected: 4007301; Actual: 4007300 / GT-BDY-013: responseCode mismatch. Expected: 4007301; Actual: 4007300
```
