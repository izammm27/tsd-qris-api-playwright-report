...
- Name: api\get-token\get-token.combination.spec.ts >> Get Token B2B combination and validation priority >> GT-CMB-010 - invalid Content-Type and format rusak JSON / Invalid Content-Type and malformed JSON
- Location: tests\api\get-token\get-token.combination.spec.ts:176:9

# Error details

```
Error: GT-CMB-010: responseCode tidak sesuai. Expected: 4007301; Actual: 4007300 / GT-CMB-010: responseCode mismatch. Expected: 4007301; Actual: 4007300
```
