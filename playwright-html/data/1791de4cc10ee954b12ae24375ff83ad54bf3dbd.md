...
- Name: api\get-token\get-token.header-negative.spec.ts >> Get Token B2B header negative >> GT-HDR-019 - X-CLIENT-KEY multiple spasi kosong / X-CLIENT-KEY multiple whitespace
- Location: tests\api\get-token\get-token.header-negative.spec.ts:16:9

# Error details

```
Error: GT-HDR-019: responseCode tidak sesuai. Expected: 4007301; Actual: 4007302 / GT-HDR-019: responseCode mismatch. Expected: 4007301; Actual: 4007302
```
