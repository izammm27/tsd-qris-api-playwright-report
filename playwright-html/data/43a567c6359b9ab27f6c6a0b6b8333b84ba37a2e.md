...
- Name: api\get-token\get-token.body-negative.spec.ts >> Get Token B2B body negative and raw body contract >> GT-BDY-034 - partnerId boolean / partnerId boolean
- Location: tests\api\get-token\get-token.body-negative.spec.ts:16:9

# Error details

```
Error: GT-BDY-034: responseCode tidak sesuai. Expected: 4007301; Actual: 4007300 / GT-BDY-034: responseCode mismatch. Expected: 4007301; Actual: 4007300
```
