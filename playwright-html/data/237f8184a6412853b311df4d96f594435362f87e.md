...
- Name: api\get-token\get-token.signature-negative.spec.ts >> Get Token B2B signature negative >> GT-SIG-002 - X-signature string kosong / X-SIGNATURE empty string
- Location: tests\api\get-token\get-token.signature-negative.spec.ts:252:9

# Error details

```
Error: GT-SIG-002: responseCode tidak sesuai. Expected: 4007301; Actual: 4007302 / GT-SIG-002: responseCode mismatch. Expected: 4007301; Actual: 4007302
```
