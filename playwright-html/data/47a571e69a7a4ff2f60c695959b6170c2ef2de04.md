...
```
Error: GT-BDY-043: HTTP status berdasarkan expected responseCode tidak sesuai. Expected: 400; Actual: 401 / GT-BDY-043: HTTP status based on expected responseCode mismatch. Expected: 400; Actual: 401
```
