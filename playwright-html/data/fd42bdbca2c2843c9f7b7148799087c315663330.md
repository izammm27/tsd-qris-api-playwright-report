...
- Name: api\cancel-qris\cancel-qris.body-negative.spec.ts >> Cancel QRIS body negative >> CNL-BDY-012 - originalReferenceNo length 65 / originalReferenceNo length 65
- Location: tests\api\cancel-qris\cancel-qris.body-negative.spec.ts:13:9

# Error details

```
Error: CNL-BDY-012: responseCode tidak sesuai. Expected: 4007701; Actual: 2007700 / CNL-BDY-012: responseCode mismatch. Expected: 4007701; Actual: 2007700
```
