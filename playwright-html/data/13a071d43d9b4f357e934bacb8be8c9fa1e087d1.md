...
- Name: api\get-token\get-token.header-negative.spec.ts >> Get Token B2B header negative >> GT-HDR-035 - valid JSON body dengan Content-Type text/plain / Valid JSON body with Content-Type text/plain
- Location: tests\api\get-token\get-token.header-negative.spec.ts:16:9

# Error details

```
Error: Error schema response error untuk GT-HDR-035 / Error response schema errors for GT-HDR-035
