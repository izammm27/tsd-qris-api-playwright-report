...
- Name: api\cancel-qris\cancel-qris.authorization-negative.spec.ts >> Cancel QRIS authorization negative >> CNL-AUTH-002 - Authorization empty / Authorization empty
- Location: tests\api\cancel-qris\cancel-qris.authorization-negative.spec.ts:56:9

# Error details

```
Error: CNL-AUTH-002: responseCode tidak sesuai. Expected: 4017701; Actual: 4017700 / CNL-AUTH-002: responseCode mismatch. Expected: 4017701; Actual: 4017700
```
