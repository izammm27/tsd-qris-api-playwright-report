...
- Name: api\get-token\get-token.body-negative.spec.ts >> Get Token B2B body negative and raw body contract >> GT-BDY-001 - grantType tidak dikirim / grantType missing
- Location: tests\api\get-token\get-token.body-negative.spec.ts:16:9

# Error details

```
Error: GT-BDY-001: responseCode tidak sesuai. Expected: 4007302; Actual: 4007301 / GT-BDY-001: responseCode mismatch. Expected: 4007302; Actual: 4007301
```
