...
- Name: api\cancel-qris\cancel-qris.body-negative.spec.ts >> Cancel QRIS body negative >> CNL-BDY-003 - originalPartnerReferenceNo string kosong / originalPartnerReferenceNo empty string
- Location: tests\api\cancel-qris\cancel-qris.body-negative.spec.ts:13:9

# Error details

```
Error: CNL-BDY-003: responseCode tidak sesuai. Expected: 4007701; Actual: 4007702 / CNL-BDY-003: responseCode mismatch. Expected: 4007701; Actual: 4007702
```
