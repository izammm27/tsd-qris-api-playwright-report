...
- Name: api\cancel-qris\cancel-qris.body-negative.spec.ts >> Cancel QRIS body negative >> CNL-BDY-015 - additionalInfo string / additionalInfo string
- Location: tests\api\cancel-qris\cancel-qris.body-negative.spec.ts:13:9

# Error details

```
Error: CNL-BDY-015: responseCode tidak sesuai. Expected: 4007701; Actual: 4007700 / CNL-BDY-015: responseCode mismatch. Expected: 4007701; Actual: 4007700
```
