...
- Name: api\cancel-qris\cancel-qris.authorization-negative.spec.ts >> Cancel QRIS authorization negative >> CNL-AUTH-001 - Authorization tidak dikirim / Authorization missing
- Location: tests\api\cancel-qris\cancel-qris.authorization-negative.spec.ts:56:9

# Error details

```
Error: CNL-AUTH-001: responseCode tidak sesuai. Expected: 4007702; Actual: 4017700 / CNL-AUTH-001: responseCode mismatch. Expected: 4007702; Actual: 4017700
```
