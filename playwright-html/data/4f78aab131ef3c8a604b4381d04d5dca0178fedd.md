...
- Name: api\cancel-qris\cancel-qris.body-negative.spec.ts >> Cancel QRIS body negative >> CNL-BDY-010 - merchantId length 65 / merchantId length 65
- Location: tests\api\cancel-qris\cancel-qris.body-negative.spec.ts:13:9

# Error details

```
Error: CNL-BDY-010: responseCode tidak sesuai. Expected: 4007701; Actual: 4047701 / CNL-BDY-010: responseCode mismatch. Expected: 4007701; Actual: 4047701
```
