...
```
Error: GT-BDY-037: HTTP status berdasarkan expected responseCode tidak sesuai. Expected: 400; Actual: 401 / GT-BDY-037: HTTP status based on expected responseCode mismatch. Expected: 400; Actual: 401
```
