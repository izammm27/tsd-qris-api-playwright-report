...
- Name: api\cancel-qris\cancel-qris.header-negative.spec.ts >> Cancel QRIS header negative >> CNL-HDR-016 - X-timestamp multiple spasi kosong / X-TIMESTAMP multiple whitespace
- Location: tests\api\cancel-qris\cancel-qris.header-negative.spec.ts:15:9

# Error details

```
Error: CNL-HDR-016: responseCode tidak sesuai. Expected: 4007701; Actual: 4007702 / CNL-HDR-016: responseCode mismatch. Expected: 4007701; Actual: 4007702
```
