...
- Name: api\get-token\get-token.body-negative.spec.ts >> Get Token B2B body negative and raw body contract >> GT-BDY-011 - grantType boolean / grantType boolean
- Location: tests\api\get-token\get-token.body-negative.spec.ts:16:9

# Error details

```
Error: GT-BDY-011: responseCode tidak sesuai. Expected: 4007301; Actual: 4007300 / GT-BDY-011: responseCode mismatch. Expected: 4007301; Actual: 4007300
```
