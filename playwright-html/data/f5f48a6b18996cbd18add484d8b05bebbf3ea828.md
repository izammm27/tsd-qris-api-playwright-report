...
- Name: api\cancel-qris\cancel-qris.header-negative.spec.ts >> Cancel QRIS header negative >> CNL-HDR-038 - X-PARTNER-ID valid value dengan one character modified / X-PARTNER-ID valid value with one character modified
- Location: tests\api\cancel-qris\cancel-qris.header-negative.spec.ts:15:9

# Error details

```
Error: CNL-HDR-038: responseCode tidak sesuai. Expected: 4007701; Actual: 4017700 / CNL-HDR-038: responseCode mismatch. Expected: 4007701; Actual: 4017700
```
