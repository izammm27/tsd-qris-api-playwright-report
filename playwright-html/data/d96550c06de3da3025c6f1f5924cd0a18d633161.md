...
- Name: api\get-token\get-token.header-negative.spec.ts >> Get Token B2B header negative >> GT-HDR-029 - Content-Type application/xml / Content-Type application/xml
- Location: tests\api\get-token\get-token.header-negative.spec.ts:16:9

# Error details

```
Error: Error schema response error untuk GT-HDR-029 / Error response schema errors for GT-HDR-029
