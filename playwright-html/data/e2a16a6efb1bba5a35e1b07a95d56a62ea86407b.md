...
- Name: api\get-token\get-token.header-negative.spec.ts >> Get Token B2B header negative >> GT-HDR-018 - X-CLIENT-KEY satu spasi / X-CLIENT-KEY single space
- Location: tests\api\get-token\get-token.header-negative.spec.ts:16:9

# Error details

```
Error: GT-HDR-018: responseCode tidak sesuai. Expected: 4007301; Actual: 4007302 / GT-HDR-018: responseCode mismatch. Expected: 4007301; Actual: 4007302
```
