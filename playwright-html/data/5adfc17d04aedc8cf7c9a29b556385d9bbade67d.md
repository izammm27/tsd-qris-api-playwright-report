...
- Name: api\cancel-qris\cancel-qris.authorization-negative.spec.ts >> Cancel QRIS authorization negative >> CNL-AUTH-003 - Bearer tanpa token / Bearer without token
- Location: tests\api\cancel-qris\cancel-qris.authorization-negative.spec.ts:56:9

# Error details

```
Error: CNL-AUTH-003: responseCode tidak sesuai. Expected: 4017701; Actual: 4017700 / CNL-AUTH-003: responseCode mismatch. Expected: 4017701; Actual: 4017700
```
