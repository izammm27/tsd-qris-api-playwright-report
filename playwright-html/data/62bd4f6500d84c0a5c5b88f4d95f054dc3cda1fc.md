...
- Name: api\get-token\get-token.header-negative.spec.ts >> Get Token B2B header negative >> GT-HDR-013 - X-timestamp multiple spasi kosong / X-TIMESTAMP multiple whitespace
- Location: tests\api\get-token\get-token.header-negative.spec.ts:16:9

# Error details

```
Error: GT-HDR-013: responseCode tidak sesuai. Expected: 4007301; Actual: 4007302 / GT-HDR-013: responseCode mismatch. Expected: 4007301; Actual: 4007302
```
