...
- Name: api\cancel-qris\cancel-qris.header-negative.spec.ts >> Cancel QRIS header negative >> CNL-HDR-009 - Authorization satu spasi / Authorization single space
- Location: tests\api\cancel-qris\cancel-qris.header-negative.spec.ts:15:9

# Error details

```
Error: CNL-HDR-009: responseCode tidak sesuai. Expected: 4007701; Actual: 4017700 / CNL-HDR-009: responseCode mismatch. Expected: 4007701; Actual: 4017700
```
