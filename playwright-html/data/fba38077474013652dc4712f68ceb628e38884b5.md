...
- Name: api\get-token\get-token.combination.spec.ts >> Get Token B2B combination and validation priority >> GT-CMB-004 - valid headers and tidak dikirim grantType / Valid headers and missing grantType
- Location: tests\api\get-token\get-token.combination.spec.ts:176:9

# Error details

```
Error: GT-CMB-004: responseCode tidak sesuai. Expected: 4007302; Actual: 4007301 / GT-CMB-004: responseCode mismatch. Expected: 4007302; Actual: 4007301
```
