...
- Name: api\get-token\get-token.signature-negative.spec.ts >> Get Token B2B signature negative >> GT-SIG-003 - X-signature spasi kosong / X-SIGNATURE whitespace
- Location: tests\api\get-token\get-token.signature-negative.spec.ts:252:9

# Error details

```
Error: GT-SIG-003: responseCode tidak sesuai. Expected: 4007301; Actual: 4007302 / GT-SIG-003: responseCode mismatch. Expected: 4007301; Actual: 4007302
```
