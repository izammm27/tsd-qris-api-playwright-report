...
```
Error: CNL-BDY-006: responseMessage Cancel tidak sesuai TSD untuk responseCode 4007702. Expected responseMessage: Missing Mandatory Field {merchantId}; Actual responseMessage: Invalid Mandatory Field {merchantId} / CNL-BDY-006: Cancel responseMessage does not match TSD for responseCode 4007702. Expected responseMessage: Missing Mandatory Field {merchantId}; Actual responseMessage: Invalid Mandatory Field {merchantId}
```
