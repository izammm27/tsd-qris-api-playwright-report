...
- Name: api\cancel-qris\cancel-qris.body-negative.spec.ts >> Cancel QRIS body negative >> CNL-BDY-013 - reason number / reason number
- Location: tests\api\cancel-qris\cancel-qris.body-negative.spec.ts:13:9

# Error details

```
Error: CNL-BDY-013: responseCode tidak sesuai. Expected: 4007701; Actual: 4007700 / CNL-BDY-013: responseCode mismatch. Expected: 4007701; Actual: 4007700
```
