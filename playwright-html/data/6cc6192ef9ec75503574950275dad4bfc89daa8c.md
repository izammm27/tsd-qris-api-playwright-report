...
- Name: api\cancel-qris\cancel-qris.body-negative.spec.ts >> Cancel QRIS body negative >> CNL-BDY-005 - originalPartnerReferenceNo length 65 / originalPartnerReferenceNo length 65
- Location: tests\api\cancel-qris\cancel-qris.body-negative.spec.ts:13:9

# Error details

```
Error: CNL-BDY-005: responseCode tidak sesuai. Expected: 4007701; Actual: 4047701 / CNL-BDY-005: responseCode mismatch. Expected: 4007701; Actual: 4047701
```
