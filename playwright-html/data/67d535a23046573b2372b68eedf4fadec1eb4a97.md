...
- Name: api\cancel-qris\cancel-qris.signature-negative.spec.ts >> Cancel QRIS signature negative >> CNL-SIG-002 - X-signature spasi kosong / X-SIGNATURE whitespace
- Location: tests\api\cancel-qris\cancel-qris.signature-negative.spec.ts:15:9

# Error details

```
Error: CNL-SIG-002: responseCode tidak sesuai. Expected: 4017700; Actual: 4007702 / CNL-SIG-002: responseCode mismatch. Expected: 4017700; Actual: 4007702
```
