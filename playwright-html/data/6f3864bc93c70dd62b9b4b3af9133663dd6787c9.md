...
- Name: api\get-token\get-token.header-negative.spec.ts >> Get Token B2B header negative >> GT-HDR-028 - X-signature trailing spasi kosong / X-SIGNATURE trailing whitespace
- Location: tests\api\get-token\get-token.header-negative.spec.ts:16:9

# Error details

```
Error: GT-HDR-028: HTTP status berdasarkan expected responseCode tidak sesuai. Expected: 400; Actual: 401 / GT-HDR-028: HTTP status based on expected responseCode mismatch. Expected: 400; Actual: 401
```
