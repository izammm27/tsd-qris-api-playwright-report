...
- Name: api\get-token\get-token.header-negative.spec.ts >> Get Token B2B header negative >> GT-HDR-030 - Content-Type text/plain / Content-Type text/plain
- Location: tests\api\get-token\get-token.header-negative.spec.ts:16:9

# Error details

```
Error: Error schema response error untuk GT-HDR-030 / Error response schema errors for GT-HDR-030
