...
- Name: api\get-token\get-token.body-negative.spec.ts >> Get Token B2B body negative and raw body contract >> GT-BDY-041 - partnerId 64-character unregistered value / partnerId 64-character unregistered value
- Location: tests\api\get-token\get-token.body-negative.spec.ts:16:9

# Error details

```
Error: GT-BDY-041: HTTP status berdasarkan expected responseCode tidak sesuai. Expected: 400; Actual: 401 / GT-BDY-041: HTTP status based on expected responseCode mismatch. Expected: 400; Actual: 401
```
