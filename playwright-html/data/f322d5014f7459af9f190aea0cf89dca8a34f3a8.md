...
```
Error: GT-HDR-002: responseMessage tidak sesuai TSD untuk responseCode 4007302. Expected responseMessage: Missing Mandatory Field {X-TIMESTAMP}; Actual responseMessage: Invalid Mandatory Field {X-TIMESTAMP} / GT-HDR-002: responseMessage does not match TSD for responseCode 4007302. Expected responseMessage: Missing Mandatory Field {X-TIMESTAMP}; Actual responseMessage: Invalid Mandatory Field {X-TIMESTAMP}
```
