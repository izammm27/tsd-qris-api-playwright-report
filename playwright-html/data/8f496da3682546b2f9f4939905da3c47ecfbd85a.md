...
- Name: api\get-token\get-token.header-negative.spec.ts >> Get Token B2B header negative >> GT-HDR-031 - Content-Type application/pdf / Content-Type application/pdf
- Location: tests\api\get-token\get-token.header-negative.spec.ts:16:9

# Error details

```
Error: Error schema response error untuk GT-HDR-031 / Error response schema errors for GT-HDR-031
